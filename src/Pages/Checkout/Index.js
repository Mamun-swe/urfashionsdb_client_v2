...
const Index = () => {
    ...
    const onSubmit = async (data) => {
        ...
        if (!shippingArea) return setShippingErr(true)
    ...
    const downloadOrder = () => window.print()
                                ...
                                <div className="card rounded-0">
                                    <div className="card-body">
                                        ...
                                        <div className="input-fields">
                                            ...
                                            {/* Shipping Area */}
                                            <div className="shipping mt-2 mb-4">
                                                <div className="d-md-flex">
                                                    ...
                                                    <div className="px-md-3">
                                                        <div className="form-check">
                                                            ...
                                                            />
                                                            <label className="form-check-label" htmlFor="out-side-dhaka">Outside Dhaka (120 TK)</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div>
                                                        <div className="form-check">
                                                            ...
                                                            />
                                                            <label className="form-check-label" htmlFor="in-side-dhaka">Dhaka City (60 TK)</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="form-group">
                                                <p className="text-muted">Note (optional)</p>
                                                <textarea
                                                    name="note"
                                                    className="form-control shadow-none"
                                                    placeholder="আপনার স্পেশাল কোন রিকোয়ারমেন্ট থাকলে এখানে লিখুন। যেমন: পণ্যর সাইজ, কালার, সংখ্যা, ডেলিভারি টাইম ও তারিখ, পছন্দের কুরিয়ার অন্যান্য..."
                                                    rows="5"
                                                    ref={register()}
                                                />
                                            </div>
